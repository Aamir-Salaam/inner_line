<?php
						 ...
						 /*  
					      ...
					      /////////////////////
						 //////////////////////
                      mysql_query("insert into users (username,password,state_code,distt_code,role_id,role,activeYN,office_auth_code,office_auth_name,authority_name,auth_code) values('$username','$password','$state_code','$distt_code','$role_id','$role','$activeYN','$office_auth_code','$office_auth_name','$authority_name','$auth_code')")or die(mysql_error());
