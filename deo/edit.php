...
<?php
 ...
 <form class="form-horizontal" method="post"  enctype="multipart/form-data" style="float: right;">
								...
								<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="route_id" required value="<?php echo $route_id; ?>" >
                                    </div>
                                </div>
								 ...
								 <div class="control-group">
                                    <div class="controls">
										...
										<a href="update_permits.php" class="btn">Back</a>
                                    </div>
                                </div>
                            </form>
...
if (isset($_POST['update'])) {
									...
									$route_id_save = $_POST['route_id'];
									
								
mysql_query("UPDATE tourist_permit SET tour_name = '$tour_name_save' , nationality = '$nationality_save' , passport_no ='$passport_no_save',
visa_no = '$visa_no_save',route_id = '$route_id_save' WHERE id = '$id'") or die(mysql_error()); 	
?>
<script>
window.location="update_permits.php";
</script>
