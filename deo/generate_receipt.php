        ...
        <div class="span9">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                ...
                <tbody>
                    ...
                    <?php
                    $user_query = mysql_query("select * from tourist_permit where status='Pending' AND receipt_status IS NULL")or die(mysql_error());
                    while ($row = mysql_fetch_array($user_query)) {
                        ...
                        <tr class="del<?php echo $id ?>">
                            ...
                            <td style="text-align:center" width="140">
                                ...
                                <a href="make_rec.php<?php echo '?id='.$id; ?>" title="Edit" class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
                                <!--
