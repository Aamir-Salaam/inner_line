...
var file_inp = document.getElementById('fileField').value;
if(tour_nm==''||tour_fath_nm=='' ||tour_dob=='' ||tour_prof=='' ||country=='' ||tour_addr=='' ||country=='' ||tour_passno=='' ||tour_pass_issue=='' ||tour_pass_valid=='' ||tour_visano=='' ||tour_visa_issue=='' ||tour_visa_valid=='' ||route_id=='' ||tour_permit_issue=='' ||tour_permit_valid=='' ||file_inp=='')
...
<div id="my_camera"></div>
    ...
    <!-- A button for taking snaps -->
        ...
        <button type="button" name="snap" class="btn btn-success" value="Take Snapshot" onClick="take_snapshot()" style="width:150px;height:50px">Take Snapshot</button>
    ...
    <script language="JavaScript">
        ...
        function take_snapshot() {
			...
			<form method="post" name="tour_form" action="upload_data.php" enctype="multipart/form-data">
			<div>
			<fieldset>
			...
			<tr>
			<td>
			<input name="fileField" type="file" id="fileField" value="fileField" required/>&nbsp;*
