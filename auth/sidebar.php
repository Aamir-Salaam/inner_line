...
<ul class="nav nav-pills nav-stacked">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="schedule.php"><i class="icon-list icon-large"></i>&nbsp;Permits<i class="icon-arrow-right icon-large"></i>
	<span class="caret"></span>
	</a>
		<ul class="dropdown-menu">
      <li><a href="view_permits.php">View Permits</a></li>
      <li><a href="#">Submenu 1-2</a></li>
      <li><a href="#">Submenu 1-3</a></li> 
    </ul>
	</li>
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="user.php"><i class="icon-user icon-large"></i>&nbsp;User Accounts<i class="icon-arrow-right icon-large"></i>
	<span class="caret"></span>
	</a>
		<ul class="dropdown-menu">
      <li><a href="user.php">Users</a></li>
      <li><a href="#">Users Pending</a></li>
      <li><a href="#">Users Approved</a></li> 
    </ul>
	</li>
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="members.php"><i class="icon-group icon-large"></i>&nbsp;Members<i class="icon-arrow-right icon-large"></i>
	<span class="caret"></span>
	</a>
		<ul class="dropdown-menu">
