...
<?php
 ...
 <form class="form-horizontal" method="post"  enctype="multipart/form-data" style="float: right;">
                                ...
                                <div class="control-group">
								 ...
								 <div><label>Are you sure you want to approve this permit application?</label></div><br/>
...
if (isset($_POST['update'])) {
									...
									$permit_no = $str_id."/Sml/".$year;
									
									}
									else if($str_distt_code === '01'){
									
									$permit_no = $str_id."/Kin/".$year;
									
									}
								
mysql_query("UPDATE tourist_permit SET status = '$status' , approve_reject_date = '$approve_reject_date' , res_to_reject = NULL , permit_no ='$permit_no' WHERE id = '$id'") or die(mysql_error()); 	
?>
<script>
