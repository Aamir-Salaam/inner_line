            ...
            <div class="nav-collapse collapse">
                ...
                <form class="navbar-search pull-right">
                  ...
                  -->
				  								<ul>
				<li>
				<div class="login_sign_up" style="height:30px">
    <a rel="tooltip"  data-placement="left" title="Click Here to Login" id="login" href="login.php"  class="btn btn-info btn-medium"><i class="icon-signin icon-large"></i>&nbsp;Login</a>
...
<div class="container">
    <div class="margin-top">
        <div class="row">
            <div class="span12">
                <span>
<img src="img/hplogo.jpg" style="height:150px; vertical-align:bottom">
</span>
<span>
<img src="img/Inner_line.jpg"  style="height:200px; width:950px">
</span>
				<!--
